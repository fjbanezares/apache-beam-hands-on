...
with beam.Pipeline() as p:
    ...
    events = p | beam.Create(
        [
            {"userId": "Andy", "click": 1, "timestamp": 1603112520},  # Event time: 13:02 https://www.epochconverter.com
            {"userId": "Sam", "click": 1000, "timestamp": 1603113240},  # Event time: 13:14
            {"userId": "Andy", "click": 1, "timestamp": 1603115820},  # Event time: 13:57
            {"userId": "Andy", "click": 1, "timestamp": 1603113600},  # Event time: 13:20
            {"userId": "Andy", "click": 22, "timestamp": 1603113600},  # Event time: 13:20
    ...
    windowed_events = timestamped_events | beam.WindowInto(
        ...
        # We close the session after 30 minutes then
